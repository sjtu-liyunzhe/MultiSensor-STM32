...
u8 MPU_Write_Len(int imuNum, u8 addr,u8 reg,u8 len,u8 *buf);//IIC连续写
u8 MPU_Read_Len(int imuNum, u8 addr,u8 reg,u8 len,u8 *buf); //IIC连续读 
u8 MPU_Write_Byte(int imuNum, u8 reg,u8 data);				//IIC写一个字节
u8 MPU_Read_Byte(int imuNum, u8 reg);						//IIC读一个字节

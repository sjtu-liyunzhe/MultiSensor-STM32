...
/****************************************************ÕâÀïÉèÖÃnRESET****************************************************/
#if defined(MCU_IS_STM32F7XX)  // STM's STM32F7XX, using *GPIOB2* as nRESET  // avoid to use PE3, boards like Aplolo have problems in output high simutenous to nearby PIO e.g. PE3&PE4
#define  M8266WIFI_nRESET_GPIO_RCC_CLOCK_EN				  __HAL_RCC_GPIOB_CLK_ENABLE()
#define  M8266WIFI_nRESET_GPIO											GPIOB
#define  M8266WIFI_nRESET_PIN											GPIO_PIN_11
//#define  M8266WIFI_nRESET_GPIO_RCC_CLOCK_EN				  __HAL_RCC_GPIOB_CLK_ENABLE()
//#define  M8266WIFI_nRESET_GPIO											GPIOB
...
/****************************************************ÕâÀïÉèÖÃnCS****************************************************/
#if defined(MCU_IS_STM32F7XX)  // STM's STM32F7XX, using *GPIOE4* as nCS
...
#if defined(MCU_IS_STM32F7XX) || defined(MCU_IS_STM32L1XX) || defined(MCU_IS_STM32L4XX) // STM's STM32F7XX, STM32L1XX, STM32L4XX, using HAL 
#define GPIO_InitStructure_AS_GPIO_OUTPUT(gpio,pin)						\
...
#if   defined(MCU_IS_STM32F3XX) || defined(MCU_IS_STM32F7XX) || defined(MCU_IS_STM32L1XX) || defined(MCU_IS_STM32L4XX) // STM's STM32F3XX, STM32F7XX, STM32L1XX, STM32L4XX
...
#if defined(MCU_IS_STM32F7XX) || defined(MCU_IS_STM32L1XX) || defined(MCU_IS_STM32L4XX) || defined(MCU_IS_STM32H7XX)  	// STM's STM32F7XX, STM32L1XX, STM32L4XX, STM32F7XX, using HAL 
#define GPIO_InitStructure_AS_AF(gpio,pins)										\
  ...
  GPIO_InitStructure.Alternate = 0x05U;												\
	HAL_GPIO_Init(GPIOE, &GPIO_InitStructure)		//ÕâÀï²»ÖªµÀÒª²»Òª¸ÄEÎªB£¡£¡£¡£¡£¡£¡£¡£¡£¡£¡£¡£¡£¡£¡£¡£¡£¡£¡£¡
